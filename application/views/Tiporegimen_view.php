...
<div class="col-xs-12 col-sm-12 col-md-10" id="panelHome" name="cuerpo">
  <div class="panel panel-success">
    ...
    <!-- Inicio Modal Registro Regimen -->
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" name="modalRegimen" data-backdrop="static" data-keyboard="true">
      <div class="modal-dialog" id="cuerpo" role="document">
        <div class="modal-content" id="newCliente">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><center>Registrar Regimen</h4>
          </div>
          <div class="modal-body">
            <form name="formSaveActividad" id="formSaveActividad">
              ...
              <div class="form-group">
                  <div class="row">
                    <div class="col-xs-0">
                      <input type="hidden" id="codigo_regimen" name="codigo_regimen">
          ...
          <div class="modal-footer">
            <center>
              ...
              <button type="button" class="btn btn-primary" id="btnSavingRegimen" name="btnSavingRegimen"  >Registrar</button>
            </center>
          </div>
        </div>
      </div>
  ...
  <!-- Fin Modal Regimen -->
    ...
    <script type="text/javascript">
        $.getScript('<?php echo base_url(); ?>js/regimen.js');
    </script>
