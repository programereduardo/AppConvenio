...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'convenio.png')) {
		$tcpdf_header_logo = 'convenio.png';
	}
...
if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Convenio Sena - Universidad Simón Bolívar');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Reportes de Insasistencias');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Convenio Sena - Universidad Simón Bolívar");
}
