...
$route['asistencias'] = 'asistencias_controller';
...
$route['Fichas'] = 'Fichas_controller';
$route['tipo_documentos'] = 'tipodocumentos_controller';
$route['tipo_ubicaciones'] = 'tipoubicaciones_controller';
$route['Instructores'] = 'Instructores_controller';
$route['aprendiz'] = 'terceros_controller/aprendiz';
...
$route['relacion-Instructores'] = 'Relinstructores_controller';
$route['relacion-aprendiz'] = 'Relaprendiz_controller';
$route['reportes-inasistencias'] = 'Reportes_inasistencias_controller';
$route['pdf'] = 'pdf_controller';
$route['datos_personales'] = 'apredatpersonales_controller';
$route['redirect'] = 'changepass_controller';
$route['actualizar_informacion'] = 'apredatpersonales_controller/redireccionarformulario';
