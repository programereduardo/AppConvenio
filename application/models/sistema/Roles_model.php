  ...
  class roles_model extends CI_model
  {
    ...
    public function obtener_modulos($data)
    {
      ...
      $sql = "SELECT DISTINCT
              ...
              LEFT JOIN seg_acciones AS accion ON seg_accion = acc_codigo AND acc_descripcion = 'Ver'
              LEFT JOIN seg_modulos AS modulos ON acc_modulo = mod_codigo
    ...
    public function obtener_acciones($data)
    {
      ...
      $sql = "SELECT DISTINCT
            ...
            acc_descripcion
            FROM  seg_permisos AS permisos
            LEFT JOIN seg_acciones AS acciones ON seg_accion = acc_codigo AND acc_estado = 1
            JOIN seg_modulos as modulos ON acc_modulo = mod_codigo AND mod_codigo = $modulo
            WHERE SEG_ROLES = $rol
